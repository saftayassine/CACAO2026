...
public class StockEq7 {
    ...
    */
    ...
    public String toString(){
        return "Nom du propriétaire du stock : " + this.getCreateur().getNom() + ". Stock de bass qualité : " + Double.toString(this.getLowQ()) + ". Stock de moyenne qualité : " + Double.toString(this.getMedQ()) + ". Stock de haute qualité : " + Double.toString(this.getHighQ())  ;
    }
