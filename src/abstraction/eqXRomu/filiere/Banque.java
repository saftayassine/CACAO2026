...
public class Banque implements IActeur, IAssermente {
	...
	public Banque() {
		...
		this.journalCouts = new Journal("Les couts payes par les acteurs", this);
	...
	public void communiqueCryptos(Object o) {
		if (o instanceof IAssermente) {
			((IAssermente)o).setCryptos(this.cryptogramme);
		}
	}
